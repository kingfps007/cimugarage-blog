...
（如果 `blog-config.yml` 中 `birth.show: true`，此处显示今日/本周/本月/今年已过百分比。默认不公开出生日期。）

## 编辑说明

为方便读者，本站采用双语编辑。所有内容经过 AI 翻译和笔者校核。如发现翻译错误，欢迎邮件反馈。

## 备案

- ICP 备案：[晋ICP备2026000871号-1](https://beian.miit.gov.cn/)
- 公安备案：[晋公网安备14010902001829号](https://beian.mps.gov.cn/)
